...
<div class="card">
    <div class="d-flex justify-content-between align-items-center">
        <h5 class="card-header">Data Jumbotron</h5>
        <div class="me-4">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <img src="{{asset("images/".$data->images)}}" style="width: 200px" alt="">
              </td>
              <td>{{$data->title}}</td>
              <td>{{$data->paragraph}}</td>
              @include('admin.pages.jumbotron.edit')
              @include('admin.pages.jumbotron.delete')
            </tr>
            @endforeach
          </tbody>
        </table>
...
@include('admin.pages.jumbotron.tambah')
