<div class="modal fade" id="tambah" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" role="document">
        <form action="/admin-pplg/jumbotron" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Tambah Jumbotron</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <input type="text" id="nameBasic" class="form-control" name="paragraph">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col mb-3">
