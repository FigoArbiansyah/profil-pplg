<div class="modal fade" id="tambah" tabindex="-1" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" role="document">
        <form action="/admin-pplg/karya-siswa" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel1">Tambah Karya Siswa</h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" id="student_name" class="form-control" name="student_name" value="{{ old('student_name') }}" required>
                            @error('student_name')
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="file" id="student_image" class="form-control" name="student_image" required>
                            @error('student_image')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" id="student_instagram_url" class="form-control" name="student_instagram_url" value="{{ old('student_instagram_url') }}">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" id="student_linkedin_url" class="form-control" name="student_linkedin_url" value="{{ old('student_linkedin_url') }}">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <input type="text" id="student_github_url" class="form-control" name="student_github_url" value="{{ old('student_github_url') }}">
